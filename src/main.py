...
try:
    ...
    # cozeloop 与 LangChain 1.0+ 不兼容时降级处理
    def init_run_config(*args, **kwargs):
        pass
    def init_agent_config(*args, **kwargs):
        pass
...
# 静态文件服务（预览界面）
import os
static_dir = os.path.join(os.getenv("COZE_WORKSPACE_PATH", os.path.dirname(os.path.dirname(__file__))), "static")
